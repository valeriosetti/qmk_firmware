...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_MINS,                       KC_EQL,  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_ENT,
             KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_QUOT,                       KC_QUOT, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,
    ...
    _______, CS_Q,    CS_W,    ACC_E,   _______, _______, _______,                       _______, _______, ACC_U,   ACC_I,   ACC_O,   _______, _______,
             ACC_A,   _______, _______, _______, _______, AP_QUOT,                       AP_QUOT, _______, _______, _______, _______, _______,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case KC_RSFT:
            ...
            if (shift_is_held) {
                writePinLow(SHIFT_LED);
            } else {
                writePinHigh(SHIFT_LED);
            }
            break;
        case AP_QUOT:
            if (record->event.pressed) {
